...
\bred{Plan: elaborate on: some questions have already arisen that are in want of such a resource-bounded version}

But what if we restrict attention to claims about proofs of bounded length?  Is there then some sense in which self-trust can be recovered?  
